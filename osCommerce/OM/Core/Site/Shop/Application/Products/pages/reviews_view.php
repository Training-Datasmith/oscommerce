...
<div style="float: right; text-align: center;">
  ...
  <?php echo '<p>' . HTML::button(['href' => OSCOM::getLink(null, 'Cart', 'Add&' . $OSCOM_Product->getKeyword()), 'icon' => 'cart', 'title' => OSCOM::getDef('button_add_to_cart')]) . '</p>'; ?>
</div>
...
<div class="submitFormButtons">
  <span style="float: right;"><?php echo HTML::button(['href' => OSCOM::getLink(null, null, 'Reviews&Write&' . $OSCOM_Product->getKeyword()), 'icon' => 'pencil', 'title' => OSCOM::getDef('button_write_review')]); ?></span>

  <?php echo HTML::button(['href' => OSCOM::getLink(null, null, 'Reviews&' . $OSCOM_Product->getKeyword()), 'icon' => 'triangle-1-w', 'title' => OSCOM::getDef('button_back')]); ?>
</div>
