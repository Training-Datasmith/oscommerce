...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <?php echo OSCOM::getDef('choose_shipping_destination'). '<br /><br />' . HTML::button(['href' => OSCOM::getLink(null, null, 'Shipping&Address', 'SSL'), 'icon' => 'home', 'title' => OSCOM::getDef('button_change_address')]); ?>
...
<?php
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td width="10">&nbsp;</td>
            <td colspan="3"><b><?php echo $quotes['module']; ?></b>&nbsp;<?php if (isset($quotes['icon']) && !empty($quotes['icon'])) {
                echo $quotes['icon'];
            } ?></td>
            <td width="10">&nbsp;</td>
          </tr>
