...
<div class="moduleBox">
  ...
  <div class="content">
    <?php echo sprintf(OSCOM::getDef('order_conditions_description'), OSCOM::getLink(null, 'Info', 'Conditions', 'AUTO')) . '<br /><br />' . HTML::checkboxField('conditions', [['id' => 1, 'text' => OSCOM::getDef('order_conditions_acknowledge')]], false); ?>
  </div>
</div>
...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <?php echo OSCOM::getDef('choose_billing_destination'). '<br /><br />' . HTML::button(['href' => OSCOM::getLink(null, null, 'Billing&Address', 'SSL'), 'icon' => 'home', 'title' => OSCOM::getDef('button_change_address')]); ?>
