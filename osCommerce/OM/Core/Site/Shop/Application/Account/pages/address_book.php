...
<?php
    ...
    ?>
        ...
        <td align="right"><?php echo HTML::button(['href' => OSCOM::getLink(null, null, 'AddressBook&Edit=' . $Qaddresses->valueInt('address_book_id'), 'SSL'), 'title' => OSCOM::getDef('button_edit')]) . '&nbsp;' . HTML::button(['href' => OSCOM::getLink(null, null, 'AddressBook&Delete=' . $Qaddresses->valueInt('address_book_id'), 'SSL'), 'title' => OSCOM::getDef('button_delete')]); ?></td>
      </tr>
      <tr>
...
<?php
  if ($counter < MAX_ADDRESS_BOOK_ENTRIES) {
      echo HTML::button(['href' => OSCOM::getLink(null, null, 'AddressBook&Create', 'SSL'), 'icon' => 'plus', 'title' => OSCOM::getDef('button_add_address')]);
  } else {
