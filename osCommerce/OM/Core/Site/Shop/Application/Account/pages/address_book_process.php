...
<?php
    ...
    echo HTML::button(['href' => $back_link, 'icon' => 'triangle-1-w', 'title' => OSCOM::getDef('button_back')]);
    ?>
...
<div class="submitFormButtons">
  <?php HTML::button(['href' => OSCOM::getLink(null, null, 'AddressBook', 'SSL'), 'icon' => 'triangle-1-w', 'title' => OSCOM::getDef('button_back')]); ?>
</div>
