...
class Edit
{
    public static function execute(Application_Abstract $application)
    {
        ...
        $application->set_page_title(OSCOM::get_def('account_edit_heading'));
        ...
        if ($OSCOM_Service->is_started('Breadcrumb')) {
            $OSCOM_Breadcrumb->add(OSCOM::get_def('breadcrumb_edit_account'), OSCOM::get_link(null, null, 'Edit', 'SSL'));
        }
    }
}