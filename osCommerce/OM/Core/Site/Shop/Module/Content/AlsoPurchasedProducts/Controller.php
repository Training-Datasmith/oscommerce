...
class Controller extends \osCommerce\OM\Core\Modules
{
    ...
    {
        if (!isset($this->_keys)) {
            $this->_keys = ['MODULE_CONTENT_ALSO_PURCHASED_MIN_DISPLAY', 'MODULE_CONTENT_ALSO_PURCHASED_MAX_DISPLAY', 'MODULE_CONTENT_ALSO_PURCHASED_PRODUCTS_CACHE'];
        }
