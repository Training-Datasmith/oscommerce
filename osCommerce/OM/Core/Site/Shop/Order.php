...
class Order
{
    ...
    public static function insert()
    {
        ...
        if ($OSCOM_Customer->isLoggedOn()) {
            ...
            $customer_address = ['company' => $OSCOM_ShoppingCart->getShippingAddress('company'),
    ...
    public static function sendEmail($id)
    {
        ...
        if ($Qorder->fetch() !== false) {
            ...
            if ((strlen($Qorder->value('delivery_name')) > 0) && (strlen($Qorder->value('delivery_street_address')) > 0)) {
                $address = ['name' => $Qorder->value('delivery_name'),
            ...
            $address = ['name' => $Qorder->value('billing_name'),
    ...
    public function query($order_id)
    {
        ...
        $this->delivery = ['name' => $Qorder->valueProtected('delivery_name'),
        ...
        $this->billing = ['name' => $Qorder->valueProtected('billing_name'),
        ...
        while ($Qproducts->fetch()) {
            ...
            $this->products[$index] = ['qty' => $Qproducts->valueInt('products_quantity'),
            ...
            while ($Qvariants->fetch()) {
                $this->products[$index]['attributes'][$subindex] = ['option' => $Qvariants->value('group_title'),
