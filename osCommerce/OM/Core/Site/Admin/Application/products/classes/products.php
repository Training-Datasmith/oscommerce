...
class osC_Products_Admin
{
    public static function get($id)
    {
        ...
        if ($data['has_children'] == '1') {
            ...
            while ($Qsubproducts->next()) {
                $variants_array[$Qsubproducts->valueInt('products_id')]['data'] = ['price' => $Qsubproducts->value('products_price'),
                ...
                while ($Qvariants->next()) {
                    $variants_array[$Qsubproducts->valueInt('products_id')]['values'][$Qvariants->valueInt('group_id')][$Qvariants->valueInt('value_id')] = ['value_id' => $Qvariants->valueInt('value_id'),
    ...
    public static function getAll($category_id = null, $pageset = 1)
    {
        ...
        while ($Qproducts->next()) {
            ...
            $extra_data = ['products_price_formatted' => $price,
