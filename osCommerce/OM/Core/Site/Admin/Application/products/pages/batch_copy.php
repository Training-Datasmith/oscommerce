...
?>
  ...
  <p><?php echo '<b>' . $osC_Language->get('field_copy_method') . '</b><br />' . osc_draw_radio_field('copy_as', [['id' => 'link', 'text' => $osC_Language->get('copy_method_link')], ['id' => 'duplicate', 'text' => $osC_Language->get('copy_method_duplicate')]], 'link', null, '<br />'); ?></p>
