...
<div class="infoBoxContent">
  ...
  <fieldset>
    ...
    <div><label for="copy_as"><?php echo $osC_Language->get('field_copy_method'); ?></label><?php echo osc_draw_radio_field('copy_as', [['id' => 'link', 'text' => $osC_Language->get('copy_method_link')], ['id' => 'duplicate', 'text' => $osC_Language->get('copy_method_duplicate')]], 'link', null, '<br />'); ?></div>
  </fieldset>
