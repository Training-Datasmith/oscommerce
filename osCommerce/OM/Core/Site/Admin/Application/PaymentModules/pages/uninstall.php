...
<div class="infoBox">
  ...
  <p><?php echo HTML::button(['priority' => 'primary', 'icon' => 'trash', 'title' => OSCOM::getDef('button_uninstall')]) . ' ' . HTML::button(['href' => OSCOM::getLink(), 'priority' => 'secondary', 'icon' => 'close', 'title' => OSCOM::getDef('button_cancel')]); ?></p>
