 ...
 */
namespace Os_Commerce\OM\Core\Site\Admin\Application\Services\Action\Install;
...
class Process
{
    public static function execute(Application_Abstract $application)
    {
        ...
        if (Services::install($data)) {
            ...
            $OSCOM_SM = new $class();
            if ($OSCOM_SM->has_keys()) {
                OSCOM::redirect(OSCOM::get_link(null, null, 'Save&code=' . $data));
            } else {
