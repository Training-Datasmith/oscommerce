...
echo osc_icon('banner_preview.png') . ' ' . $os_c_object_info->get('banners_title');
?></div>
<div class="infoBoxContent">

<?php 
if (!osc_empty($os_c_object_info->get('banners_html_text'))) {
    echo $os_c_object_info->get('banners_html_text');
} else {
    echo osc_image('../images/' . $os_c_object_info->get('banners_image'), $os_c_object_info->get('banners_title'));
}
?>
