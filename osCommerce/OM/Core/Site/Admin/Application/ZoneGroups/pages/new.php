...
<div class="infoBox">
  <h3><?php 
echo HTML::icon('new.png') . ' ' . OSCOM::get_def('action_heading_new_zone_group');
?></h3>
...
?>" method="post">
  ...
  <p><?php 
echo OSCOM::get_def('introduction_new_zone_group');
?></p>
...
?></label><?php 
echo HTML::input_field('zone_description');
?></p>
  </fieldset>
