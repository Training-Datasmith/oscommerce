...
echo osc_icon('new.png') . ' ' . $_GET['file'];
?></div>
<div class="infoBoxContent">
  <form name="bRestoreLocal" action="<?php 
echo osc_href_link_admin(FILENAME_DEFAULT, $os_c_template->get_module() . '&file=' . $_GET['file'] . '&action=restore');
?>" method="post" enctype="multipart/form-data">

  <p><?php 
echo $os_c_language->get('introduction_restore_file');
?></p>
