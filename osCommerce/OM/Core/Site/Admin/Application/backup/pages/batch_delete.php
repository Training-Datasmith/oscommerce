...
echo osc_icon('trash.png') . ' ' . $os_c_language->get('action_heading_batch_delete_backup_files');
?></div>
<div class="infoBoxContent">
  <form name="bDeleteBatch" action="<?php 
echo osc_href_link_admin(FILENAME_DEFAULT, $os_c_template->get_module() . '&action=batchDelete');
?>" method="post">

  <p><?php 
echo $os_c_language->get('introduction_batch_delete_backup_files');
?></p>
