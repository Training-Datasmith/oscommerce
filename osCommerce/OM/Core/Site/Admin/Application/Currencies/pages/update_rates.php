...
<div class="infoBox">
  ...
  <p><?php echo HTML::button(['priority' => 'primary', 'icon' => 'refresh', 'title' => OSCOM::getDef('button_update')]) . ' ' . HTML::button(['href' => OSCOM::getLink(), 'priority' => 'secondary', 'icon' => 'close', 'title' => OSCOM::getDef('button_cancel')]); ?></p>
