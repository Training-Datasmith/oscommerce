...
<form id="liveSearchForm">
  ...
  <span style="float: right;"><?php echo HTML::button(['href' => OSCOM::getLink(null, null, 'UpdateRates'), 'icon' => 'refresh', 'title' => OSCOM::getDef('button_update_currency_exchange_rates')]) . ' ' . HTML::button(['href' => OSCOM::getLink(null, null, 'Save'), 'icon' => 'plus', 'title' => OSCOM::getDef('button_insert')]); ?></span>
</form>
