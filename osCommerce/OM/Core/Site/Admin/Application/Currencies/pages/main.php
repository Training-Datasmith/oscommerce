...
echo HTML::button(['href' => OSCOM::get_link(null, null, 'UpdateRates'), 'icon' => 'refresh', 'title' => OSCOM::get_def('button_update_currency_exchange_rates')]) . ' ' . HTML::button(['href' => OSCOM::get_link(null, null, 'Save'), 'icon' => 'plus', 'title' => OSCOM::get_def('button_insert')]);
?></span>
</form>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="currenciesDataTable">
  <thead>
    <tr>
      <th><?php 
echo OSCOM::get_def('table_heading_currencies');
?></th>
      <th><?php 
...
?>';
  ...
  var cEditLink = '<?php 
echo OSCOM::get_link(null, null, 'Save&id=CID');
?>';
  var cEditLinkIcon = '<?php 
echo HTML::icon('edit.png');
?>';

  var cDeleteLink = '<?php 
echo OSCOM::get_link(null, null, 'Delete&id=CID');
?>';
  var cDeleteLinkIcon = '<?php 
