...
*/
$os_c_directory_listing = new Os_C_directory_Listing('includes/modules/shipping');
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
  <thead>
    <tr>
      <th><?php 
echo $os_c_language->get('table_heading_shipping_modules');
?></th>
      <th><?php 
...
foreach ($files as $file) {
    ...
    if (class_exists('osC_Shipping_' . $class)) {
        $os_c_language->inject_definitions('modules/shipping/' . $class . '.xml');
...
echo '<b>' . $os_c_language->get('table_action_legend') . '</b> ' . osc_icon('edit.png') . '&nbsp;' . $os_c_language->get('icon_edit') . '&nbsp;&nbsp;' . osc_icon('install.png') . '&nbsp;' . $os_c_language->get('icon_install') . '&nbsp;&nbsp;' . osc_icon('uninstall.png') . '&nbsp;' . $os_c_language->get('button_uninstall');
?></td>
  </tr>
</table>
