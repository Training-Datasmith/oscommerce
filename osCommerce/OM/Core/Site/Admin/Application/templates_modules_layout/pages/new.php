...
echo osc_icon('new.png') . ' ' . $os_c_language->get('action_heading_new_template_layout_module');
?></div>
<div class="infoBoxContent">
  <form name="lNew" action="<?php 
echo osc_href_link_admin(FILENAME_DEFAULT, $os_c_template->get_module() . '&set=' . $_GET['set'] . '&filter=' . $_GET['filter'] . '&action=save');
?>" method="post">

  <p><?php 
echo $os_c_language->get('introduction_new_template_layout_module');
?></p>

  <table border="0" width="100%" cellspacing="0" cellpadding="2">
    <tr>
      <td width="40%"><?php 
echo '<b>' . $os_c_language->get('field_modules') . '</b>';
?></td>
      <td width="60%"><?php 
echo osc_draw_pull_down_menu('box', $boxes_array, null, 'style="width: 100%;"');
?></td>
    </tr>
    <tr>
      <td width="40%"><?php 
...
?></td>
      <td width="60%"><?php 
echo osc_draw_pull_down_menu('content_page', $pages_array, null, 'style="width: 100%;"');
?></td>
    </tr>
    <tr>
      <td width="40%">&nbsp;</td>
      <td width="60%"><?php 
echo osc_draw_checkbox_field('page_specific') . '&nbsp;<b>' . $os_c_language->get('field_page_specific') . '</b>';
?></td>
    </tr>
    <tr>
      <td width="40%"><?php 
...
<?php 
if (!empty($groups_array)) {
    echo osc_draw_pull_down_menu('group', $groups_array, null, 'style="width: 30%;"') . '&nbsp;&nbsp;<b>' . $os_c_language->get('field_group_new') . '</b>&nbsp;';
}
...
?></td>
      <td width="60%"><?php 
echo osc_draw_input_field('sort_order', null, 'style="width: 100%;"');
?></td>
    </tr>
  </table>
