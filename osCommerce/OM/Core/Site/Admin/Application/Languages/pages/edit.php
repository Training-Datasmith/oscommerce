...
foreach (ObjectInfo::to(Currencies::getAll(-1))->get('entries') as $c) {
    $currencies_array[] = ['id' => $c['currencies_id'],
                                'text' => $c['title']];
}
...
<div class="infoBox">
  ...
  <fieldset>
    ...
    <p><label for="text_direction"><?php echo OSCOM::getDef('field_text_direction'); ?></label><?php echo HTML::selectMenu('text_direction', [['id' => 'ltr', 'text' => 'ltr'], ['id' => 'rtl', 'text' => 'rtl']], $OSCOM_ObjectInfo->get('text_direction')); ?></p>
