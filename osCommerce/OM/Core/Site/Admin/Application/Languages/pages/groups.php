...
<form id="liveSearchForm">
  ...
  <span style="float: right;"><?php echo HTML::button(['href' => OSCOM::getLink(), 'priority' => 'secondary', 'icon' => 'triangle-1-w', 'title' => OSCOM::getDef('button_back')]) . ' ' . HTML::button(['href' => OSCOM::getLink(null, null, 'InsertDefinition&id=' . $_GET['id']), 'icon' => 'plus', 'title' => OSCOM::getDef('button_insert')]); ?></span>
</form>
