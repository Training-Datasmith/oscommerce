...
<div class="infoBox">
  <h3><?php 
echo HTML::icon('trash.png') . ' ' . $oscom_object_info->get_protected('name');
?></h3>
...
if ($oscom_object_info->get('code') == DEFAULT_LANGUAGE) {
  ...
  <p><?php 
    echo '<b>' . OSCOM::get_def('introduction_delete_language_invalid') . '</b>';
    ?></p>
...
<?php 
  ...
  <p><?php 
    echo OSCOM::get_def('introduction_delete_language');
    ?></p>

  <p><?php 
    echo '<b>' . $oscom_object_info->get_protected('name') . '</b>';
    ?></p>
