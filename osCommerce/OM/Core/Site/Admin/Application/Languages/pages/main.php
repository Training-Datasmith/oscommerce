...
echo HTML::button(['href' => OSCOM::get_link(null, null, 'Import'), 'icon' => 'triangle-1-se', 'title' => OSCOM::get_def('button_import')]);
?></span>
</form>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="langDataTable">
  <thead>
    <tr>
      <th><?php 
echo OSCOM::get_def('table_heading_languages');
?></th>
      <th width="20">&nbsp;</th>
      <th><?php 
echo OSCOM::get_def('table_heading_code');
?></th>
      <th width="150"><?php 
...
echo HTML::submit_image(HTML::icon_raw('trash.png'), OSCOM::get_def('icon_trash'), 'onclick="document.batch.action=\'' . OSCOM::get_link(null, null, 'BatchDelete') . '\';"');
?></th>
      <th align="center" width="20"><?php 
echo HTML::checkbox_field('batchFlag', null, null, 'onclick="flagCheckboxes(this);"');
?></th>
...
echo '<b>' . OSCOM::get_def('table_action_legend') . '</b> ' . HTML::icon('edit.png') . '&nbsp;' . OSCOM::get_def('icon_edit') . '&nbsp;&nbsp;' . HTML::icon('export.png') . '&nbsp;' . OSCOM::get_def('icon_export') . '&nbsp;&nbsp;' . HTML::icon('trash.png') . '&nbsp;' . OSCOM::get_def('icon_trash');
?></span>
...
echo OSCOM::get_link(null, null, 'id=LANGUAGEID');
?>';
...
echo HTML::image(OSCOM::get_public_site_link('images/worldflags/LANGUAGECODE.png', null, 'Shop'), 'LANGUAGENAME');
?>';

  var languageEditLink = '<?php 
echo OSCOM::get_link(null, null, 'Save&id=LANGUAGEID');
?>';
...
echo OSCOM::get_link(null, null, 'Export&id=LANGUAGEID');
?>';
  var languageExportLinkIcon = '<?php 
echo HTML::icon('export.png');
?>';

  var languageDeleteLink = '<?php 
echo OSCOM::get_link(null, null, 'Delete&id=LANGUAGEID');
?>';
  var languageDeleteLinkIcon = '<?php 
...
?>';
  var defaultText = '<?php 
echo addslashes(OSCOM::get_def('default_entry'));
?>';
