...
<form id="liveSearchForm">
  ...
  <span style="float: right;"><?php echo HTML::button(['href' => OSCOM::getLink(null, null, 'id=' . $_GET['id']), 'priority' => 'secondary', 'icon' => 'triangle-1-w', 'title' => OSCOM::getDef('button_back')]) . ' ' . HTML::button(['href' => OSCOM::getLink(null, null, 'InsertDefinition&id=' . $_GET['id'] . '&group=' . $_GET['group']), 'icon' => 'plus', 'title' => OSCOM::getDef('button_insert')]); ?></span>
</form>
