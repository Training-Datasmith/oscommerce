...
class Import
{
    public static function execute($data)
    {
        ...
        if ($Qlanguage->is_error()) {
            ...
            if (!isset($data['id'])) {
                $data['id'] = $OSCOM_PDO->last_insert_id();
            }
        ...
        if ($error === false) {
            foreach ($data['definitions'] as $def) {
                ...
                if ($data['import_type'] == 'replace') {
                    ...
                    $Qcheck->bind_int(':languages_id', $data['id']);
                ...
                if ($insert === true || $update === true) {
                    ...
                    $Qdef->bind_int(':languages_id', $data['id']);
                    $Qdef->bind_value(':content_group', $def['group']);
                    $Qdef->bind_value(':definition_key', $def['key']);
        ...
        if ($add_category_and_product_placeholders === true) {
            if ($error === false) {
                ...
                $Qcategories->bind_int(':language_id', $data['default_language_id']);
                $Qcategories->execute();
                while ($Qcategories->fetch()) {
                    ...
                    $Qinsert->bind_int(':categories_id', $Qcategories->value_int('categories_id'));
                    $Qinsert->bind_int(':language_id', $data['id']);
                    $Qinsert->bind_value(':categories_name', $Qcategories->value('categories_name'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                $Qproducts->bind_int(':language_id', $data['default_language_id']);
                $Qproducts->execute();
                while ($Qproducts->fetch()) {
                    ...
                    $Qinsert->bind_int(':products_id', $Qproducts->value_int('products_id'));
                    $Qinsert->bind_int(':language_id', $data['id']);
                    $Qinsert->bind_value(':products_name', $Qproducts->value('products_name'));
                    $Qinsert->bind_value(':products_description', $Qproducts->value('products_description'));
                    $Qinsert->bind_value(':products_keyword', $Qproducts->value('products_keyword'));
                    $Qinsert->bind_value(':products_tags', $Qproducts->value('products_tags'));
                    $Qinsert->bind_value(':products_url', $Qproducts->value('products_url'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                $Qattributes->bind_int(':languages_id', $data['default_language_id']);
                $Qattributes->execute();
                while ($Qattributes->fetch()) {
                    ...
                    $Qinsert->bind_int(':id', $Qattributes->value_int('id'));
                    $Qinsert->bind_int(':products_id', $Qattributes->value_int('products_id'));
                    $Qinsert->bind_int(':languages_id', $data['id']);
                    $Qinsert->bind_value(':value', $Qattributes->value('value'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                $Qgroups->bind_int(':languages_id', $data['default_language_id']);
                $Qgroups->execute();
                while ($Qgroups->fetch()) {
                    ...
                    $Qinsert->bind_int(':id', $Qgroups->value_int('id'));
                    $Qinsert->bind_int(':languages_id', $data['id']);
                    $Qinsert->bind_value(':title', $Qgroups->value('title'));
                    $Qinsert->bind_int(':sort_order', $Qgroups->value_int('sort_order'));
                    $Qinsert->bind_value(':module', $Qgroups->value('module'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                $Qvalues->bind_int(':languages_id', $data['default_language_id']);
                $Qvalues->execute();
                while ($Qvalues->fetch()) {
                    ...
                    $Qinsert->bind_int(':id', $Qvalues->value_int('id'));
                    $Qinsert->bind_int(':languages_id', $data['id']);
                    $Qinsert->bind_int(':products_variants_groups_id', $Qvalues->value_int('products_variants_groups_id'));
                    $Qinsert->bind_value(':title', $Qvalues->value('title'));
                    $Qinsert->bind_int(':sort_order', $Qvalues->value_int('sort_order'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                $Qmanufacturers->bind_int(':languages_id', $data['default_language_id']);
                ...
                while ($Qmanufacturers->fetch()) {
                    ...
                    $Qinsert->bind_int(':manufacturers_id', $Qmanufacturers->value_int('manufacturers_id'));
                    $Qinsert->bind_int(':languages_id', $data['id']);
                    $Qinsert->bind_value(':manufacturers_url', $Qmanufacturers->value('manufacturers_url'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                $Qstatus->bind_int(':language_id', $data['default_language_id']);
                $Qstatus->execute();
                while ($Qstatus->fetch()) {
                    ...
                    $Qinsert->bind_int(':orders_status_id', $Qstatus->value_int('orders_status_id'));
                    $Qinsert->bind_int(':language_id', $data['id']);
                    $Qinsert->bind_value(':orders_status_name', $Qstatus->value('orders_status_name'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                while ($Qstatus->fetch()) {
                    ...
                    $Qinsert->bind_int(':id', $Qstatus->value_int('id'));
                    $Qinsert->bind_int(':language_id', $data['id']);
                    $Qinsert->bind_value(':status_name', $Qstatus->value('status_name'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                $Qstatus->bind_int(':languages_id', $data['default_language_id']);
                $Qstatus->execute();
                while ($Qstatus->fetch()) {
                    ...
                    $Qinsert->bind_int(':id', $Qstatus->value_int('id'));
                    $Qinsert->bind_int(':languages_id', $data['id']);
                    $Qinsert->bind_value(':title', $Qstatus->value('title'));
                    $Qinsert->bind_value(':css_key', $Qstatus->value('css_key'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                while ($Qstatus->fetch()) {
                    ...
                    $Qinsert->bind_int(':weight_class_id', $Qstatus->value_int('weight_class_id'));
                    $Qinsert->bind_value(':weight_class_key', $Qstatus->value('weight_class_key'));
                    $Qinsert->bind_int(':language_id', $data['id']);
                    $Qinsert->bind_value(':weight_class_title', $Qstatus->value('weight_class_title'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
            ...
            if ($error === false) {
                ...
                $Qgroup->bind_int(':language_id', $data['default_language_id']);
                $Qgroup->execute();
                while ($Qgroup->fetch()) {
                    ...
                    $Qinsert->bind_int(':id', $Qgroup->value_int('id'));
                    $Qinsert->bind_int(':language_id', $data['id']);
                    $Qinsert->bind_value(':title', $Qgroup->value('title'));
                    $Qinsert->bind_value(':code', $Qgroup->value('code'));
                    $Qinsert->bind_int(':size_width', $Qgroup->value('size_width'));
                    $Qinsert->bind_int(':size_height', $Qgroup->value('size_height'));
                    $Qinsert->bind_int(':force_size', $Qgroup->value('force_size'));
                    $Qinsert->execute();
                    if ($Qinsert->is_error()) {
                        $error = true;
                        break;
