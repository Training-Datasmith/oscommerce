...
echo osc_icon('trash.png') . ' ' . $os_c_object_info->get('weight_class_title');
?></div>
<div class="infoBoxContent">
  <form name="wcDelete" action="<?php 
echo osc_href_link_admin(FILENAME_DEFAULT, $os_c_template->get_module() . '&page=' . $_GET['page'] . '&wcID=' . $os_c_object_info->get('weight_class_id') . '&action=delete');
?>" method="post">
...
?>
  ...
  <p><?php 
echo $os_c_language->get('introduction_delete_weight_class');
?></p>

  <p><?php 
echo '<b>' . $os_c_object_info->get('weight_class_title') . '</b>';
?></p>
