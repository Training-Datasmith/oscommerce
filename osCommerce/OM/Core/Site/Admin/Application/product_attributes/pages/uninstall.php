...
echo osc_href_link_admin(FILENAME_DEFAULT, $os_c_template->get_module() . '&module=' . basename($_GET['module']) . '&action=uninstall');
?>" method="post">

  <p><?php 
echo $os_c_language->get('introduction_uninstall_product_attribute_module');
?></p>
