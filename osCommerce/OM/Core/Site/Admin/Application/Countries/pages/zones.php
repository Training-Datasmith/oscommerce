...
echo HTML::button(['href' => OSCOM::get_link(), 'priority' => 'secondary', 'icon' => 'triangle-1-w', 'title' => OSCOM::get_def('button_back')]) . ' ' . HTML::button(['href' => OSCOM::get_link(null, null, 'ZoneSave&id=' . $_GET['id']), 'icon' => 'plus', 'title' => OSCOM::get_def('button_insert')]);
?></span>
</form>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="countryZonesDataTable">
  <thead>
    <tr>
      <th><?php 
echo OSCOM::get_def('table_heading_zones');
?></th>
      <th><?php 
echo OSCOM::get_def('table_heading_zone_code');
?></th>
      <th width="150"><?php 
...
echo HTML::submit_image(HTML::icon_raw('trash.png'), OSCOM::get_def('icon_trash'), 'onclick="document.batch.action=\'' . OSCOM::get_link(null, null, 'BatchDeleteZones&id=' . $_GET['id']) . '\';"');
?></th>
      <th align="center" width="20"><?php 
echo HTML::checkbox_field('batchFlag', null, null, 'onclick="flagCheckboxes(this);"');
?></th>
...
echo OSCOM::get_rpc_link(null, null, 'GetAllZones&id=' . $_GET['id']);
?>';

  var zoneEditLink = '<?php 
echo OSCOM::get_link(null, null, 'ZoneSave&id=' . $_GET['id'] . '&zID=ZONEID');
?>';
...
echo OSCOM::get_link(null, null, 'ZoneDelete&id=' . $_GET['id'] . '&zID=ZONEID');
?>';
  var zoneDeleteLinkIcon = '<?php 
