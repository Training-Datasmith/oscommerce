...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="countryDataTable">
  <thead>
    <tr>
      <th><?php 
echo OSCOM::get_def('table_heading_countries');
?></th>
      <th width="20">&nbsp;</th>
      <th><?php 
...
?>';
  ...
  var countryLink = '<?php 
echo OSCOM::get_link(null, null, 'id=COUNTRYID');
?>';
...
?>';
  ...
  var countryFlag = '<?php 
echo HTML::image(OSCOM::get_public_site_link('images/worldflags/COUNTRYISOCODE2.png', null, 'Shop'), 'COUNTRYNAME');
?>';

  var countryEditLink = '<?php 
echo OSCOM::get_link(null, null, 'Save&id=COUNTRYID');
?>';
...
echo OSCOM::get_link(null, null, 'Delete&id=COUNTRYID');
?>';
