 ...
 */
namespace Os_Commerce\OM\Core\Site\Admin\Application\Categories\Action\Delete;
...
class Process
{
    ...
    {
        $parent_id = $application->get_tree()->get_parent_id($_GET['id']);
        ...
        OSCOM::redirect(OSCOM::get_link(null, null, 'cid=' . $parent_id));
    }
}