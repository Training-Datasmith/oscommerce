...
<div class="infoBox">
  <h3><?php 
echo HTML::icon('trash.png') . ' ' . $oscom_object_info->get_protected('user_name');
?></h3>
...
?>" method="post">
  ...
  <p><?php 
echo OSCOM::get_def('introduction_delete_administrator');
?></p>

  <p><?php 
echo '<b>' . $oscom_object_info->get('user_name') . '</b>';
?></p>
