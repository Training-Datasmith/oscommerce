...
?>';
  ...
  var adminEditLink = '<?php 
echo OSCOM::get_link(null, null, 'Save&id=ADMINID');
?>';
  var adminEditLinkIcon = '<?php 
echo HTML::icon('edit.png');
?>';

  var adminDeleteLink = '<?php 
echo OSCOM::get_link(null, null, 'Delete&id=ADMINID');
?>';
  var adminDeleteLinkIcon = '<?php 
