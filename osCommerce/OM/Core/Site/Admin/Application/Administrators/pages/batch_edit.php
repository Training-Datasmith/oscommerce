...
?>
  ...
  <fieldset>
    <p><?php echo HTML::radioField('mode', [['id' => Administrators::ACCESS_MODE_ADD, 'text' => OSCOM::getDef('add_to')], ['id' => Administrators::ACCESS_MODE_REMOVE, 'text' => OSCOM::getDef('remove_from')], ['id' => Administrators::ACCESS_MODE_SET, 'text' => OSCOM::getDef('set_to')]], Administrators::ACCESS_MODE_ADD); ?></p>
