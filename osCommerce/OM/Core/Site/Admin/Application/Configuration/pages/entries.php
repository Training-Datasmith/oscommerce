...
echo HTML::submit_image(HTML::icon_raw('edit.png'), OSCOM::get_def('icon_edit'), 'onclick="document.batch.action=\'' . OSCOM::get_link(null, null, 'BatchSaveEntries&id=' . $_GET['id']) . '\';"');
?></th>
      <th align="center" width="20"><?php 
echo HTML::checkbox_field('batchFlag', null, null, 'onclick="flagCheckboxes(this);"');
?></th>
...
echo '<b>' . OSCOM::get_def('table_action_legend') . '</b> ' . HTML::icon('edit.png') . '&nbsp;' . OSCOM::get_def('icon_edit');
?></span>
...
?>';
  ...
  var configEditLink = '<?php 
echo OSCOM::get_link(null, null, 'EntrySave&id=' . (int) $_GET['id'] . '&pID=CONFIGID');
?>';
  var configEditLinkIcon = '<?php 
