 ...
 */
namespace Os_Commerce\OM\Core\Site\Admin\Application\Configuration\Action\Entry_Save;
...
class Process
{
    ...
    {
        $data = ['key' => key($_POST['configuration']), 'value' => $_POST['configuration'][key($_POST['configuration'])]];
