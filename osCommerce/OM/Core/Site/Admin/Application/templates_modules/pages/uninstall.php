...
echo osc_href_link_admin(FILENAME_DEFAULT, $os_c_template->get_module() . '&set=' . $_GET['set'] . '&module=' . $module->get_code() . '&action=uninstall');
?>" method="post">

  <p><?php 
echo $os_c_language->get('introduction_uninstall_module');
?></p>
...
?></p>
  ...
  <p align="center"><?php 
echo osc_draw_hidden_field('subaction', 'confirm') . '<input type="submit" value="' . $os_c_language->get('button_uninstall') . '" class="operationButton" /> <input type="button" value="' . $os_c_language->get('button_cancel') . '" onclick="document.location.href=\'' . osc_href_link_admin(FILENAME_DEFAULT, $os_c_template->get_module() . '&set=' . $_GET['set']) . '\';" class="operationButton" />';
?></p>
