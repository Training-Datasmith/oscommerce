...
*/
class Os_C_application_templates_modules extends Os_C_template_admin
{
    /* Protected variables */
    ...
    public function __construct()
    {
        ...
        $os_c_language->load('modules-' . $_GET['set']);
