...
<div class="infoBox">
  <h3><?php 
echo HTML::icon('new.png') . ' ' . OSCOM::get_def('action_heading_new_tax_rate');
?></h3>
...
?>" method="post">
  ...
  <p><?php 
echo OSCOM::get_def('introduction_new_tax_rate');
?></p>
