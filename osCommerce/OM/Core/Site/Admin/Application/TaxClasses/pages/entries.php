...
?></th>
      <th><?php 
echo OSCOM::get_def('table_heading_tax_rate_zone');
?></th>
      <th width="100"><?php 
...
echo OSCOM::get_link(null, null, 'EntrySave&id=' . $_GET['id'] . '&rID=ENTRYID');
?>';
...
echo OSCOM::get_link(null, null, 'EntryDelete&id=' . $_GET['id'] . '&rID=ENTRYID');
?>';
