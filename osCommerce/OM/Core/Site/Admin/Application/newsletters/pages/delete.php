...
<div class="infoBoxContent">
  <form name="nDelete" action="<?php 
echo osc_href_link_admin(FILENAME_DEFAULT, $os_c_template->get_module() . '&page=' . $_GET['page'] . '&nID=' . $os_c_object_info->get('newsletters_id') . '&action=delete');
?>" method="post">

  <p><?php 
echo $os_c_language->get('introduction_delete_newsletter');
?></p>
