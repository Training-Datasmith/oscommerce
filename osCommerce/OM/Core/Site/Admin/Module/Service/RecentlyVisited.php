...
class RecentlyVisited extends \osCommerce\OM\Core\Site\Admin\ServiceAbstract
{
    ...
    {
        $data = [['title' => 'Display latest products',
                      ...
                      ['title' => 'Maximum products to show',
                            ...
                            'group_id' => '6'],
                      ['title' => 'Display latest categories',
                      ...
                      ['title' => 'Display latest searches',
                            ...
                            'use_function' => 'osc_cfg_use_get_boolean_value',
                            'set_function' => 'osc_cfg_set_boolean_value(array(1, -1))'],
                      ['title' => 'Maximum searches to show',
    ...
    {
        return ['SERVICE_RECENTLY_VISITED_SHOW_PRODUCTS',
