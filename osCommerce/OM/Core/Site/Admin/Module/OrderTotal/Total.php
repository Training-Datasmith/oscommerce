...
class Total extends \Os_Commerce\OM\Core\Site\Admin\Order_Total
{
    public $_title;
    public $_code = 'Total';
    ...
    {
        $this->_title = OSCOM::get_def('order_total_total_title');
        $this->_description = OSCOM::get_def('order_total_total_description');
    ...
    {
        parent::install();
        $data = [['title' => 'Display Total', 'key' => 'MODULE_ORDER_TOTAL_TOTAL_STATUS', 'value' => 'true', 'description' => 'Do you want to display the total order value?', 'group_id' => '6', 'set_function' => 'osc_cfg_set_boolean_value(array(\'true\', \'false\'))'], ['title' => 'Sort Order', 'key' => 'MODULE_ORDER_TOTAL_TOTAL_SORT_ORDER', 'value' => '4', 'description' => 'Sort order of display.', 'group_id' => '6']];
