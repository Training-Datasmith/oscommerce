...
class Tax extends \Os_Commerce\OM\Core\Site\Admin\Order_Total
{
    public $_title;
    public $_code = 'Tax';
    ...
    {
        $this->_title = OSCOM::get_def('order_total_tax_title');
        $this->_description = OSCOM::get_def('order_total_tax_description');
    ...
    {
        parent::install();
        $data = [['title' => 'Display Tax', 'key' => 'MODULE_ORDER_TOTAL_TAX_STATUS', 'value' => 'true', 'description' => 'Do you want to display the order tax value?', 'group_id' => '6', 'set_function' => 'osc_cfg_set_boolean_value(array(\'true\', \'false\'))'], ['title' => 'Sort Order', 'key' => 'MODULE_ORDER_TOTAL_TAX_SORT_ORDER', 'value' => '3', 'description' => 'Sort order of display.', 'group_id' => '6']];
